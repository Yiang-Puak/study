...
| 7 | Prompt 工程与前沿趋势 | 能把 prompt 当接口设计，并回答 Agentic RAG、MCP、成本和安全 | [Prompt 工程](06_Prompt工程与AI编程工具/01_核心概念与面试答题模板.md) / [前沿趋势](12_前沿趋势/index.md) |
...
| Prompt | [入口](06_Prompt工程与AI编程工具/01_核心概念与面试答题模板.md) | [代码](06_Prompt工程与AI编程工具/02_Prompt代码实践.md) | [八股](06_Prompt工程与AI编程工具/03_Prompt高频八股.md) | [追问](06_Prompt工程与AI编程工具/04_Prompt真题与工程追问.md) |
...
- 想判断下一步最该学什么：进入 [AI 岗位学习雷达](../学习路径与速查/AI岗位学习雷达.md)
